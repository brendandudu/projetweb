 ...
 */
final class Version20210306230903 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE lodging ADD user_id INT NOT NULL, ADD created_at DATETIME NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE lodging DROP user_id, DROP created_at');
    }
}
