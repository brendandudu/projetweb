...
final class Version20210225175506 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, password VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), heading VARCHAR(255) DEFAULT NULL,sex VARCHAR(255) DEFAULT NULL,birthday VARCHAR(255) DEFAULT NULL,phone VARCHAR(255) DEFAULT NULL,country VARCHAR(255) DEFAULT NULL,city VARCHAR(255) DEFAULT NULL,avenue VARCHAR(255) DEFAULT NULL,appartment VARCHAR(255) DEFAULT NULL,code VARCHAR(255) DEFAULT NULL,address VARCHAR(255) DEFAULT NULL,PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
